    ...
    return (
        <div className="mt-8 px-16 py-4 flex items-center justify-between">
            <div className="flex flex-wrap gap-4 items-center">
                ...
                >
                    <SelectTrigger
                        className="u-shadow-2 w-[180px] text-gray-300 font-bold border-none bg-zinc-900 rounded-lg
                ...
                <div className="relative">
                    ...
                    <Input
                        ...
                        className="u-shadow-2 w-[180px] pl-9 text-gray-300 font-bold border-none outline-none bg-zinc-900 rounded-lg
